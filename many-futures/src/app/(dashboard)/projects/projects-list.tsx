...
import type { Project, Episode } from "~/lib/mock-data";
...
export default function ProjectsList({ initialProjects, episodeCounts }: ProjectsListProps) {
        ...
        {filtered.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {filtered.map((project) => {
              const episodeCount = episodeCounts[project.id] || 0;
                    ...
                    <CardContent className="p-8">
                      ...
                      <div className={`mt-6 pt-6 border-t space-y-3 ${
                        ...
                        <div className={`flex items-center gap-4 text-xs uppercase tracking-wider ${
                          ...
                          <span>
                            {project.cadenceConfig?.mode || 'WEEKLY'}
                          </span>
